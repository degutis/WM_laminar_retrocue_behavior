...
function trial_Instr_2RoutineBegin(snapshot) {
  return function () {
    ...
    trial_Instr_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function masks_Instr_2RoutineBegin(snapshot) {
  return function () {
    ...
    masks_Instr_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function cue_InstrRoutineBegin(snapshot) {
  return function () {
    ...
    cue_InstrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function responseInst_uncuedRoutineBegin(snapshot) {
  return function () {
    ...
    responseInst_uncuedComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function noncuedProbe_PracticeRoutineBegin(snapshot) {
  return function () {
    ...
    noncuedProbe_PracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function feedback_2_noncueRoutineBegin(snapshot) {
  return function () {
    ...
    feedback_2_noncueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function perceptCorrectCalc_practiceRoutineBegin(snapshot) {
  return function () {
    ...
    perceptCorrectCalc_practiceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function noncuedProbeRoutineBegin(snapshot) {
  return function () {
    ...
    noncuedProbeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
